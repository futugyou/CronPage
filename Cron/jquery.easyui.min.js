...
(function ($) {
    function _46(_47) {
        ...
        $(_47).bind('_dragover', function (e, _4a) {
            $.data(_47, 'droppable').options.onDragOver.apply(_47, [
              e,
              _4a
            ])
        });
        $(_47).bind('_drop', function (e, _4b) {
            $.data(_47, 'droppable').options.onDrop.apply(_47, [
              e,
              _4b
            ])
        })
...
(function ($) {
    ...
    $.fn.dialog.parseOptions = function (_257) {
        return $.extend({
        }, $.fn.window.parseOptions(_257), $.parser.parseOptions(_257, [
          'toolbar',
          'buttons'
        ]))
    };
...
(function ($) {
    function init(_35f) {
        ...
        function _363(menu) {
            var _366 = $.parser.parseOptions(menu[0], [
            'width'
            ]).width;
            if (menu.hasClass('menu-content')) {
...
(function ($) {
    ...
    $.fn.menubutton.parseOptions = function (_3a1) {
        var t = $(_3a1);
        return $.extend({
        }, $.fn.linkbutton.parseOptions(_3a1), $.parser.parseOptions(_3a1, [
        'menu',
        {
            plain: 'boolean',
            duration: 'number'
...
(function ($) {
    ...
    $.fn.splitbutton.parseOptions = function (_3ac) {
        var t = $(_3ac);
        return $.extend({
        }, $.fn.linkbutton.parseOptions(_3ac), $.parser.parseOptions(_3ac, [
        'menu',
        {
            plain: 'boolean',
            duration: 'number'
...
(function ($) {
    ...
    $.fn.numberbox.parseOptions = function (_422) {
        var t = $(_422);
        return $.extend({
        }, $.fn.validatebox.parseOptions(_422), $.parser.parseOptions(_422, [
        'decimalSeparator',
        'groupSeparator',
        'suffix',
        {
...
(function ($) {
    ...
    $.fn.spinner.parseOptions = function (_461) {
        var t = $(_461);
        return $.extend({
        }, $.fn.validatebox.parseOptions(_461), $.parser.parseOptions(_461, [
        'width',
        'height',
        'min',
        'max',
...
(function ($) {
    ...
    $.fn.timespinner.parseOptions = function (_485) {
        return $.extend({
        }, $.fn.spinner.parseOptions(_485), $.parser.parseOptions(_485, [
        'separator',
        {
            showSeconds: 'boolean',
            highlight: 'number'
...
(function ($) {
    ...
    $.fn.datagrid.parseOptions = function (_62b) {
        var t = $(_62b);
        return $.extend({
        }, $.fn.panel.parseOptions(_62b), $.parser.parseOptions(_62b, [
        'url',
        'toolbar',
        'idField',
        'sortName',
...
(function ($) {
    ...
    $.fn.treegrid.parseOptions = function (_747) {
        return $.extend({
        }, $.fn.datagrid.parseOptions(_747), $.parser.parseOptions(_747, [
        'treeField',
        {
            animate: 'boolean'
        }
...
(function ($) {
    ...
    $.fn.combo.parseOptions = function (_7d8) {
        var t = $(_7d8);
        return $.extend({
        }, $.fn.validatebox.parseOptions(_7d8), $.parser.parseOptions(_7d8, [
        'width',
        'height',
        'separator',
        {
    ...
    $.fn.combobox.parseOptions = function (_80f) {
        var t = $(_80f);
        return $.extend({
        }, $.fn.combo.parseOptions(_80f), $.parser.parseOptions(_80f, [
        'valueField',
        'textField',
        'mode',
        'method',
    ...
    $.fn.combogrid.parseOptions = function (_851) {
        var t = $(_851);
        return $.extend({
        }, $.fn.combo.parseOptions(_851), $.fn.datagrid.parseOptions(_851), $.parser.parseOptions(_851, [
        'idField',
        'textField',
        'mode'
        ]))
    ...
    $.fn.datetimebox.parseOptions = function (_882) {
        var t = $(_882);
        return $.extend({
        }, $.fn.datebox.parseOptions(_882), $.parser.parseOptions(_882, [
        'timeSeparator',
        {
            showSeconds: 'boolean'
        }
